...
$db['authDB']['hostname'] = 'agcompliance.com';
$db['authDB']['username'] = 'complianceAdmin';
$db['authDB']['password'] = 'Compliance2012';
$db['authDB']['database'] = 'agCompliance';
